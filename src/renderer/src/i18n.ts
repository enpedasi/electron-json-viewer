...
export const messages = {
  en: {
    ...
    'json.copied': 'Copied',
    'json.pruneMode': 'Show search matches only',
    ...
    'table.delete': 'Delete',
    'table.tooManyOptions': '{count} more — refine your search to see them',
    'table.rowFilter': 'Row filter',
    'table.rowFilterTitle': 'Row filter: {column}',
    'table.rowFilterValues': 'Values',
    'table.rowFilterCondition': 'Condition',
    'table.rowFilterSearchValues': 'Search values',
    'table.rowFilterContains': 'contains',
    'table.rowFilterSelectAll': 'Select all',
    'table.rowFilterUnselectAll': 'Unselect all',
    'table.rowFilterTruncated': 'Showing first {count} values only',
    'table.rowFilterSummary': 'Rows: {visible}/{total}',
    'table.rowFilterClearAll': 'Clear row filters',
    'table.rowFilterEmptyString': '(empty string)',
    'table.rowFilterWhitespaceString': 'Whitespace only ({count} chars)',
    'table.unwind': 'Unwind',
    'table.unwindNone': 'None',
    'object.key': 'key',
    'object.val': 'val',
  ...
  ja: {
    ...
    'table.delete': '削除',
    'table.tooManyOptions': '他 {count} 件 — 検索で絞り込んでください',
    'table.rowFilter': '行フィルタ',
    'table.rowFilterTitle': '行フィルタ: {column}',
    'table.rowFilterValues': '値',
    'table.rowFilterCondition': '条件',
    'table.rowFilterSearchValues': '値を検索',
    'table.rowFilterContains': '含む',
    'table.rowFilterSelectAll': '全選択',
    'table.rowFilterUnselectAll': '全解除',
    'table.rowFilterTruncated': '先頭 {count} 件のみ表示',
    'table.rowFilterSummary': '行: {visible}/{total}',
    'table.rowFilterClearAll': '行フィルタを全解除',
    'table.rowFilterEmptyString': '空文字',
    'table.rowFilterWhitespaceString': '空白のみ ({count}文字)',
    'table.unwind': '展開',
    'table.unwindNone': 'なし',
    'object.key': 'キー',
    'object.val': '値',
